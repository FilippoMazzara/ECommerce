...
public class StampaCarrelloDB extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "SELECT * FROM prodotto "
                    ...
                    + " INNER JOIN vistautente ON vistautente.iduser = prodotto.iduserstore "
            ...
            if (resultSet.isBeforeFirst()) {
                ...
                while (resultSet.next()) {
                    ...
                    costoSpedizioneTotale = costoSpedizioneTotale
                            + resultSet.getDouble("costospedizione") * resultSet.getDouble("quantita");
                    out.println(
                            "<div class=\"card mb-3 \">"
                                    +
                                    ...
                                    "<img style=\"height:200px; width:200px;\" src=\"" + request.getContextPath()
                                    + "/img/prodotti/"
                    ...
                    out.println(
                            ...
                            "<br><div class=\"py-5\"><a  href=\"../eliminaitemcarrello?id="
                ...
                out.println(
                        "<div class=\"card mb-3 \" style=\"padding-top: 20px;\" >"
                                ...
                                "<div class=\"py-3\">" +
                                "<h4>Costo totale: " + decimale.format(costoFinale) + "&euro;</h4>" +
                                "</div>" +
